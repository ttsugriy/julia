...
for T = (Base.RefValue, Maybe) # both mutable and immutable
    ...
    # should be conservative when only inaccurate information is available about the object
...
@test getfield_notundefined(Tuple{Int,Int,Int}, Int)
@test getfield_notundefined(Tuple{Int,Vararg{Int}}, Int)
@test getfield_notundefined(Tuple{Any}, Int)
@test getfield_notundefined(Tuple, Int)
@test getfield_notundefined(NamedTuple{(:a, :b), Tuple{Int,Int}}, Int)
@test getfield_notundefined(NamedTuple{(:x,),Tuple{Any}}, Int)
@test getfield_notundefined(NamedTuple, Int)
